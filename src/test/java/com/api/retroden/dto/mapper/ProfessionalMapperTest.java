...
public class ProfessionalMapperTest {
    ...
    void testToProfessional() {
        ProfessionalRequest request = new ProfessionalRequest(idProfessionel,
                firstName,
                lastName,
                email,
                age,
        ...
        Professional result = professionalMapper.toProfessional(request);
        assertNotNull(result);
        assertEquals(idProfessionel,result.getIdProfessional());
    ...
    void testToProfessionelResponse() {
        Professional professional = Professional.builder()
                ...
                .build();
        ProfessionalResponse response = professionalMapper.toProfessionalResponse(professional);
